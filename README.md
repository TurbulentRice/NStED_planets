...
# COLUMN glaterr1:       Galactic Latitude [deg] Upper Unc
# COLUMN glaterr2:       Galactic Latitude [deg] Lower Unc
# COLUMN glon:           Galactic Longitude [deg]
# COLUMN glonerr1:       Galactic Longitude [deg] Upper Unc
# COLUMN glonerr2:       Galactic Longitude [deg] Lower Unc
# COLUMN elat:           Ecliptic Latitude [deg]
# COLUMN elaterr1:       Ecliptic Latitude [deg] Upper Unc
# COLUMN elaterr2:       Ecliptic Latitude [deg] Lower Unc
# COLUMN elon:           Ecliptic Longitude [deg]
# COLUMN elonerr1:       Ecliptic Longitude [deg] Upper Unc
# COLUMN elonerr2:       Ecliptic Longitude [deg] Lower Unc
